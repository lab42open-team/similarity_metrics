...
- The script `pairwise_comparisons_LLM_invoker_V2.py` in the [`llm_study_relatedness`](llm_study_relatedness/) folder requires four concurrent Ollama instances by default, each listening on a distinct port (e.g., 11434, 11435, 11436, 11437).
