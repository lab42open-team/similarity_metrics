...
# script name: isolate_GO_file.py
# developed by: Nefeli Venetsianou
# description: 
    # Retrieve only GO-relative files and save in different folder, with MGYS name. 
...
output_directory = "/ccmri/similarity_metrics/data/functional/raw_data"
...
for folder_name in target_folders:
    ...
    if os.path.exists(input_file_path):
        ...
        matching_files = [file_name for file_name in os.listdir(folder_path) if re.match(r'.+_GO(?:-slim)?_abundances_v.+\.tsv$', file_name)]
