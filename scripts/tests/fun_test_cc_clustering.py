...
def main():
    ...
    input_dir = "/ccmri/similarity_metrics/data/cc_related_only/filtered_go_files/GO_abund/raw_data/ccVSall"
    output_dir = os.path.join(input_dir, "clustering")
    input_file = os.path.join(input_dir, "ccVSall_similarity_distances.tsv")
